...
For complete syntax reference and edge cases, see [references/syntax-rules.md](syntax-rules.md)
...
- [references/syntax-rules.md](syntax-rules.md) - Complete syntax reference and error prevention
